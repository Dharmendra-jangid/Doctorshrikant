                ...
                <div class="section-menu-left">
                    <div class="box-logo">
                        <a href="{{route('admin.index')}}" id="site-logo-inner">
                            {{-- <img class="clinic" id="logo_header" alt="" src="{{asset('')}}clinic.png"
                                data-light="images/logo/logo.png" data-dark="images/logo/logo.png"> --}}
                               <h6> Dr. Srikant Mohta</h6>
                        </a>
                            ...
                            <ul class="menu-list">
                                <li class="menu-item has-children">
                                    <a href="javascript:void(0);" class="menu-item-button">
                                        <div class="icon"><i class="bi bi-arrow-bar-right"></i></div>
                                        <div class="text">Gastro Treatments</div>
                                    </a>
                                    <ul class="sub-menu">
                                        <li class="sub-menu-item">
                                            <a href="{{route('admin.addgstroTreatments')}}" class="">
                                                <div class="text">Add Gastro Treatments</div>
                                            </a>
                                        </li>
                                        <li class="sub-menu-item">
                                            <a href="{{route('admin.gastrogTreatments')}}" class="">
                                                <div class="text">Gastro Treatments</div>
                                            </a>
                                        </li>
                                    </ul>
                                ...
                                <li class="menu-item has-children">
                                    <a href="javascript:void(0);" class="menu-item-button">
                                        <div class="icon"><i class="bi bi-arrow-bar-right"></i></div>
                                        <div class="text">Liver Treatment</div>
                                    </a>
                                    <ul class="sub-menu">
                                        <li class="sub-menu-item">
                                            <a href="{{route('admin.add.livertreatments')}}" class="">
                                                <div class="text">Add Liver Treatment</div>
                                            </a>
                                        </li>
                                        <li class="sub-menu-item">
                                            <a href="{{route('admin.livertreatments')}}" class="">
                                                <div class="text">Liver Treatment</div>
                                            </a>
                                        </li>
                                    </ul>
                                ...
                                <li class="menu-item has-children">
                                    ...
                                    <ul class="sub-menu">
                                        <li class="sub-menu-item">
                                            <a href="{{route('admin.add.video')}}" class="">
                                                <div class="text">New Video</div>
                                            </a>
                                        </li>
                                        <li class="sub-menu-item">
                                            <a href="{{route('admin.video')}}" class="">
                                ...
                                <li class="menu-item">
                                    <a href="{{url('admin/abouts/1')}}" class="">
                                        <div class="icon"><i class="bi bi-person-lines-fill"></i></i></div>
                                        <div class="text">About</div>
                                    </a>
                                </li>
                                <li class="menu-item">
                                    <a href="{{route('admin.clinic')}}" class="">
                                ...
                                <li class="menu-item">
                                    <a href="{{route('admin.common.Symptoms')}}" class="">
                                        <div class="icon"><i class="bi bi-arrow-bar-right"></i></div>
                                        <div class="text">Common Symptoms </div>
                                    </a>
                                </li>
                                <li class="menu-item">
                ...
                <div class="section-content-right">
                    ...
                    <div class="main-content">
                        ...
                        <div class="bottom-page">
                            <div class="body-text "> 2024 Dr. Srikant Mohta</div>
                        </div>
                    </div>
